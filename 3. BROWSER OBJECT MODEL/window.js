...
//console.log(window); Ver los metodos que utiliza

//window.alert('Hola!'); // metodos globales
...
console.log('Alto de pantalla sin barra de Windows:', window.screen.availHeight); //avail acho o largo disponible
